...
import PrintSettingRouter from "./routes/printSetting";
import { pdfwithqr } from "./controllers/pdfwithqrcode";
...
app.use("/setting", PrintSettingRouter);
